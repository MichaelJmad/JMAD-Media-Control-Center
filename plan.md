...
### 3.3. Directory Monitor Service (`directory_monitor.py`)
...
### 3.4. Metadata Engine (`metadata_engine.py`)
...
### 3.5. File Handler (`file_handler.py`)
...
## 4. User Interface Development (Initial Phase)
